...
//        int[] intValues = new int[INPUT_SIZE * INPUT_SIZE];
    ...
    public ArrayList<Recognition> recognizeImage(Bitmap bitmap) {
        ...
        HashMap<String, String> nameMap=new HashMap<String,String>(){{
            put("2percent", "이프로");
            put("chilsung_cider", "칠성사이다");
            put("co_grape", "코코팜 포도맛");
            put("co_mango","코코팜 망고맛");
            put("co_peach", "코코팜 복숭아맛");
            put("co_white", "코코팜 화이트요구르트 맛");
            put("cocacola", "코카콜라");
            put("de_apple", "데미소다 청사과맛");
            put("de_grape_f", "데미소다 자몽맛");
            put("de_lemon", "데미소다 레몬맛");
            put("de_mango", "데미소다 망고맛");
            put("de_orange", "데미소다 오랜지맛");
            put("de_peach", "데미소다 복숭아맛");
            put("de_rapple", "데미소다 레드애플맛");
            put("de_wgrape", "데미소다 청포도맛");
            put("fanta_grape", "환타 포도맛");
            put("fanta_orange", "환타 오랜지맛");
            put("fanta_pine", "환타 파인애플맛");
            put("pepsi", "팹시");
            put("power_ade", "파워에이드");
            put("toreta", "토레타");
            put("welchs_grape", "웰치스 포도맛");
            put("welchs_orange", "웰치스 오랜지맛");
            put("welchs_strawberry", "웰치스 딸기맛");
            put("welchs_whitegrape", "웰치스 청포도맛");
